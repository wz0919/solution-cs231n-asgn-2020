...
#   import pdb; pdb.set_trace()
  ...
  if method == 'FasterRCNN':
    ...
    # if an anchor matches multiple GT boxes, choose the box with the largest iou (line 276-291)
    ...
    # use the the box with the largest iou's label to be anchor's label
